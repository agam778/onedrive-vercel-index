...
module.exports = {
  ...
  title: "Agam's ROM Builds",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/ROM-Builds',
  ...
  email: 'mailto:agam778@zohomail.in',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/agam778',
    },
    {
      name: 'Telegram',
      link: 'https://telegram.me/agam778',
    },
    {
      name: 'Donate',
      link: 'https://github.com/sponsors/agam778',
    },
  ],
